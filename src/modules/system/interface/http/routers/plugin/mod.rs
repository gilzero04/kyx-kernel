    ...
    config.service(
        web::scope("/plugins")
            ...
            .service(
                web::resource("")
                    .guard(web::guard::Get())
                    .wrap(RequirePermission::new("plugin:read", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
            ...
            .service(
                web::resource("")
                    ...
                    .wrap(RequirePermission::new("plugin:install", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
            ...
            .service(
                web::resource("/install-approved")
                    .wrap(RequirePermission::new("plugin:approve", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
            ...
            .service(
                web::resource("/{id}")
                    ...
                    .wrap(RequirePermission::new("plugin:uninstall", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
                    .route(web::delete().to(plugin::uninstall_plugin))
            )
            // POST /plugins/{id}/enable - Enable plugin
            .service(
                web::resource("/{id}/enable")
                    .wrap(RequirePermission::new("plugin:enable", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
            ...
            .service(
                web::resource("/{id}/config")
                    .wrap(RequirePermission::new("plugin:configure", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
