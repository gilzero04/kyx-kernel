...
pub fn user_routes(
    ...
    config.service(
        web::scope("/users")
            .wrap(
                RequirePermission::new("user:read", jwt.clone(), audit.clone())
                ...
                web::scope("/{id}")
                    .service(
                        web::resource("")
                            ...
                            .wrap(
                                RequirePermission::new("user:update", jwt.clone(), audit.clone())
                                    .with_redis_opt(redis.clone()),
                            ),
                    )
                    .service(
                        web::resource("")
                            ...
                            .wrap(
                                RequirePermission::new("user:delete", jwt.clone(), audit.clone())
                                    .with_redis_opt(redis.clone()),
                            ),
                    )
                    .service(
