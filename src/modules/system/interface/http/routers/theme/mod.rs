...
pub fn theme_routes(
    ...
    cfg.service(web::resource("/themes").route(web::get().to(theme::list_themes)));
    ...
    cfg.service(
        web::scope("/themes")
            ...
            .service(
                web::resource("/import")
                    .wrap(
                        RequirePermission::new("theme:import", jwt.clone(), audit.clone())
            ...
            .service(
                web::resource("/{id}/activate")
                    .wrap(
                        RequirePermission::new("theme:activate", jwt.clone(), audit.clone())
                            .with_redis_opt(redis.clone()),
                    )
            ...
            .service(
                web::resource("/{id}/sharing")
                    .wrap(
                        RequirePermission::new("theme:update", jwt.clone(), audit.clone())
                            .with_redis_opt(redis.clone()),
                    )
