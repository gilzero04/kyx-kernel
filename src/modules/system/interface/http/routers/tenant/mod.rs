...
pub fn tenant_routes_system(
    ...
    cfg.service(
        web::scope("/tenants")
            .wrap(
                RequirePermission::new("", jwt.clone(), audit.clone())
            ...
            .service(
                web::resource("")
                    .wrap(
                        RequirePermission::system("tenant:read", jwt.clone(), audit.clone())
                            .with_redis_opt(redis.clone()),
                    )
                    .route(web::get().to(tenant::list_tenants))
                    .wrap(
                        RequirePermission::system("tenant:create", jwt.clone(), audit.clone())
                            .with_redis_opt(redis.clone()),
                    )
            ...
            .service(
                web::resource("/owner")
                    .wrap(
                        RequirePermission::system("tenant:update", jwt.clone(), audit.clone())
                            .with_redis_opt(redis.clone()),
                    )
            ...
            .service(
                web::resource("/{id}")
                    ...
                    .wrap(
                        RequirePermission::system("tenant:delete", jwt.clone(), audit.clone())
