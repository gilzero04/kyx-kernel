        ...
        web::scope("/i18n")
            ...
            .service(
                web::resource("/locales")
                    .guard(web::guard::Get())
                    .wrap(RequirePermission::new("i18n:read", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
            ...
            .service(
                web::resource("/locales")
                    ...
                    .wrap(RequirePermission::new("i18n:manage", jwt.clone(), audit.clone()).with_redis_opt(redis.clone()))
