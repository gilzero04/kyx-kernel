...
impl CmsService {
    ...
    pub async fn get_page_by_slug(&self, tenant_id: Uuid, slug: &str) -> Result<Option<PageEntry>, AppError> {
        self.repo.get_page_by_slug(tenant_id, slug).await
            .map_err(|e| AppError {
                code: 500,
    ...
    #[allow(dead_code)]
    pub async fn get_published_page_by_slug(&self, slug: &str) -> Result<Option<PageEntry>, AppError> {
        self.repo.get_published_page_by_slug(slug).await
            .map_err(|e| AppError {
                code: 500,
    ...
    pub async fn get_page_by_id(&self, tenant_id: Uuid, id: Uuid) -> Result<Option<PageEntry>, AppError> {
        self.repo.get_page_by_id(tenant_id, id).await
            .map_err(|e| AppError {
                code: 500,
    ...
    pub async fn list_pages(&self, tenant_id: Uuid) -> Result<Vec<PageEntry>, AppError> {
        self.repo.list_pages(tenant_id).await
            .map_err(|e| AppError {
                code: 500,
    ...
    pub async fn delete_page(&self, tenant_id: Uuid, id: Uuid) -> Result<(), AppError> {
        self.repo.delete_page(tenant_id, id).await
            .map_err(|e| AppError {
                code: 500,
