use super::entity::{TenantEntry, BrandingEntry};
use anyhow::Result;
...
pub trait BrandingRepository: Send + Sync {
    ...
    async fn update(&self, id: sqlx::types::Uuid, branding: BrandingEntry) -> Result<BrandingEntry>;
    async fn get_by_id(&self, id: sqlx::types::Uuid) -> Result<Option<BrandingEntry>>;
    async fn get_by_tenant_id(&self, tenant_id: sqlx::types::Uuid) -> Result<Option<BrandingEntry>>;
